...
$packages=@(
 @('project-current-state','90e81ada86a925fe421d3523b14ef3079c26cef1'),
 ...
 @('v41-hardware-g2b-hw0-product-live-path-bringup-r3r2','90e81ada86a925fe421d3523b14ef3079c26cef1'))
$results=@()
