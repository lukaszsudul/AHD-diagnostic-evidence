...
P=pathlib.Path
boot='614295f4-c62b-4430-ae67-06013bea7084'
own=P('/tmp/ahd-g2b-hw0-product-r3r3-20260906T200624Z-post.lock')
receipt=json.loads((own/'receipt.json').read_text())
assert receipt=={'task':'G2B-HW0-PRODUCT-R3R3','phase':'POST_REBOOT','state':'HELD','boot':boot,'utc':receipt['utc']}
...
out={'task':'G2B-HW0-PRODUCT-R3R3','boot_id':boot,'post_reboot_linux_lock':'HELD','matching_competing_processes':processes,'other_matching_locks':locks,'open_xdma_fds':fds,'endpoint':endpoint,'result':'PASS'}
