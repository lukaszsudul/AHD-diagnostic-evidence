...
|---|---|
|rtl/g2b/v41_g2b_onech_c2h.sv:1â€“132|post-frontend tap,488 stored words,four512x64 dual-clock XPM RAM slots|
|same:803â€“1048|exact simplified marker detector,active-frame/line logic,payload packing,header and commit|
|same:1224â€“1254|RAM prefetch,common formatter padding,global word insertion,TLAST/TKEEP|
|rtl/top/ahd_capture_top_xdma.sv:39â€“42,66â€“67,100â€“105,1182â€“1240|AXI autonomous clock,I2C output composition,25kHz init,G2B-to-XDMA wiring|
|rtl/g2b/v41_g2b_mmio_router.sv:1â€“35|full-address3800..3BFF decode|
|rtl/v41/control_status_regs.sv:96â€“104|legacy overlays through367F|
|rtl/pio/pio_bar_target.sv:298â€“390|PIO slot decode,unused read0,control aliases,slot0 mirror|
|scripts/v41/g2b_build.tcl:1243â€“1255|profile flag bits8/9 and SLOT_COUNT=2|
|rtl/nvp/nvp6134c_autoinit.vhd:190â€“203|forced1080p25,input0,phaseA,AUTO off|
|rtl/nvp/nvp6134c_diagnostics_pkg.vhd:89â€“156,394â€“438|mode and output routing table|
...
|ip/v41/xdma_v41_m1.xci:47â€“48|128KiB user AXI-Lite aperture|
...
Publication: G2B_DIAG0_REMOTE_READBACK.json records independent verification of the initial architecture payload commit b75a06cb924bf5cb79239efd4706c3386bc8dcea. STATE.json publication/read-back PASS refers to that verified payload. The final receipt/manifest update is also fetched and checked independently after push; its own commit SHA is reported by the final task response to avoid a self-referential in-commit receipt.
