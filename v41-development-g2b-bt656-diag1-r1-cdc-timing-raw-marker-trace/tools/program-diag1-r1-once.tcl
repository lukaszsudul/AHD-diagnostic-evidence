# G2B-BT656-DIAG1-R1 fail-closed single volatile SRAM program procedure.
if {$argc != 0} {
  puts stderr {usage: program-diag1-r1-once.tcl}
  exit 2
}

set bitfile {C:/FPGA/G2B_BT656_DIAG1_R1_20260908T175752Z/artifacts/full_build_01/artifacts/G2B_BT656_DIAG1_R1_RAW_MARKER_TRACE.bit}
set expected_filename {G2B_BT656_DIAG1_R1_RAW_MARKER_TRACE.bit}
set expected_size 2192144
set expected_sha256 {02B590D4C6DC391A55C2EF237EA167A7352385C2BF0AD46C4DCCEA8D091684FB}
...
set invoked 0
set rc 0
emit TASK_ID G2B-BT656-DIAG1-R1
emit CANDIDATE_CLASS BT656_DIAG1_R1_RAW_MARKER_TRACE_CANDIDATE
