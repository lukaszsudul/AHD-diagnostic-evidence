...
architecture sim of tb_g0p8c5d_autoinit is
  ...
  constant I2C_HZ : positive := 25_000;
  ...
  constant C_EXPECTED_START_TO_DONE_CYCLES : natural := 651884;
  ...
  constant C_EXPECTED_PRODUCTION_LIFECYCLE_COUNT : natural := 132584734;
