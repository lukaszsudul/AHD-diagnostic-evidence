...
$run = 'C:\FPGA\G2B_BT656_FIX1_20260909T060432Z'
$linuxRun = '/home/<GOVERNED_USER_REDACTED>/vcde_artifacts/g2b_bt656_fix1/20260909T060432Z'
...
$plink = 'C:\Users\<CONTROLLER_USER_REDACTED>\Documents\ChatGPT\AHD_20260807\T1_RCA_PUTTY_CONTROL_20260820\00_PUTTY\putty-0.84-w64\plink.exe'
$hostKey = 'SHA256:yunI1fwP5I6WfGcSVkyaPxd0siCbdSiOOXVrP0wtEu8'
$login = '<GOVERNED_USER_REDACTED>'
$ip = '10.132.1.111'
...
try {
  ...
  $problem = if ($_.Exception.Message -like 'BT656FIX1_*') {
    $_.Exception.Message
  } else {
