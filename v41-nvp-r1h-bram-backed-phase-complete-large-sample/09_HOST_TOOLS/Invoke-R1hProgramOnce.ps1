...
if ($PhaseToken -eq 'Bootstrap') {
    ...
    $formalStartReceipt = Join-Path $script:R1hPrecheckRoot 'FORMAL_START_READY_RECEIPT.txt'
    ...
    $startGatePath = Join-Path $script:R1hPrecheckRoot 'R1H_FRESH_FORMAL_START_GATE.txt'
