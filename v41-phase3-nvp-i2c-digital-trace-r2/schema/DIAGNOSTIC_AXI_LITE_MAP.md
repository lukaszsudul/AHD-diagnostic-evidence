# Ephemeral R2 read-only diagnostic AXI-Lite window
...
region starts at `0x10000`. Static decode inspection therefore constrains R2 to
...
|---:|---|---:|
| `0x2000..0x20FF` | R2 identity/status | 64 words |
...
| `0x2004` | schema `0x00020000` |
| `0x2008` | flags: bit0 ephemeral, bit1 not release candidate; functional-change and host-write-required bits are zero |
...
mid-high sample is cycle 313, or 5.008 microseconds after the unchanged
functional ACK decision/SCL-release command.
