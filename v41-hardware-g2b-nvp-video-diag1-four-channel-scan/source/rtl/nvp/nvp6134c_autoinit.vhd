...
entity v40a_nvp_autoinit is
  ...
  port(
    ...
    r1f_phase_counters : out std_logic_vector(255 downto 0);
    r1f_transaction_counters : out std_logic_vector(127 downto 0);
    r1f_transaction_serial_next : out std_logic_vector(15 downto 0);
    r1f_transaction_serial_overflow : out std_logic;
    r1f_failed_txn_record_valid : out std_logic;
    r1f_failed_txn_record : out std_logic_vector(191 downto 0);
    r1f_bank_invariant_check_count : out std_logic_vector(31 downto 0);
    r1f_bank_invariant_error_count : out std_logic_vector(31 downto 0);
    r1f_first_bank_invariant_error : out std_logic_vector(31 downto 0);
    r1i_poc_telemetry : out std_logic_vector(1023 downto 0) := (others => '0')
  );
end entity;
...
begin
  ...
  u_sequence : entity work.nvp_i2c_bringup_seq_v38ek
    ...
    port map(
      ...
      r1f_phase_counters_dbg => r1f_phase_counters,
      r1f_transaction_counters_dbg => r1f_transaction_counters,
      r1f_transaction_serial_next_dbg => r1f_transaction_serial_next,
      r1f_transaction_serial_overflow_dbg => r1f_transaction_serial_overflow,
      r1f_failed_txn_record_valid_dbg => r1f_failed_txn_record_valid,
      r1f_failed_txn_record_dbg => r1f_failed_txn_record,
      r1f_bank_invariant_check_count_dbg => r1f_bank_invariant_check_count,
      r1f_bank_invariant_error_count_dbg => r1f_bank_invariant_error_count,
      r1f_first_bank_invariant_error_dbg => r1f_first_bank_invariant_error,
      r1i_poc_telemetry_dbg => r1i_poc_telemetry
    );
end architecture;
