...
module v41_g2b_onech_c2h (
  ...
  always_comb begin : BT656_DIAG1_OBSERVATION
    ...
    if (transport_req_sync2_source != transport_req_seen_source) begin
      ...
      if (!transport_hard_hold_axi && any_filling) begin
    ...
    bt656_diag_trigger_pulse = successful_eav && pending_line == 32'd1079;
    bt656_diag_next_frame_line1_commit =
        commit_pulse && pending_line == 32'd1;
    bt656_diag_event_valid = marker_event_pipe || malformed_increment ||
                             source_drop_increment || commit_pulse ||
                             bt656_diag_trigger_pulse;

    bt656_diag_event_payload = '0;
    bt656_diag_event_payload[2*32 +: 32] = marker_bytes_pipe;
    bt656_diag_event_payload[3*32 + 0] = marker_event_pipe;
    bt656_diag_event_payload[3*32 + 1] = marker_valid_pipe;
    bt656_diag_event_payload[3*32 + 2] = marker_f_pipe;
    bt656_diag_event_payload[3*32 + 3] = marker_v_pipe;
    bt656_diag_event_payload[3*32 + 4] = marker_h_pipe;
    bt656_diag_event_payload[3*32 + 5] = marker_xy_valid_pipe;
    bt656_diag_event_payload[3*32 + 6] = malformed_increment;
    bt656_diag_event_payload[3*32 + 7] = source_drop_increment;
    bt656_diag_event_payload[3*32 + 8] = commit_pulse;
    bt656_diag_event_payload[3*32 + 9] = bt656_diag_trigger_pulse;
    bt656_diag_event_payload[3*32 + 10] = source_ready_live_source;
    bt656_diag_event_payload[3*32 + 11] = enable_applied_source;
    bt656_diag_event_payload[3*32 + 12] = previous_sav_v;
    bt656_diag_event_payload[3*32 + 13] = source_locked_source;
    bt656_diag_event_payload[3*32 + 14] = locked_after;
    bt656_diag_event_payload[3*32 + 15] = monitor_has_attempt;
    bt656_diag_event_payload[3*32 + 16] = allocation_choice[2];
    bt656_diag_event_payload[3*32 + 17] = monitor_writes_slot;
    bt656_diag_event_payload[3*32 + 18] = ring_full_source;
    bt656_diag_event_payload[3*32 + 19] = ring_empty_source;
    bt656_diag_event_payload[3*32 + 20] = source_formatter_fatal;
    bt656_diag_event_payload[3*32 + 21] = source_ownership_fatal;
    bt656_diag_event_payload[3*32 + 25 +: 3] =
        bt656_diag_state_code(source_state);
    bt656_diag_event_payload[3*32 + 28 +: 3] =
        bt656_diag_state_code(state_after);
    bt656_diag_event_payload[4*32 +: 32] = source_frame_sequence;
    bt656_diag_event_payload[5*32 +: 32] = source_line_sequence;
    bt656_diag_event_payload[6*32 +: 32] = next_source_line;
    bt656_diag_event_payload[7*32 +: 32] = source_capture_sequence;
    bt656_diag_event_payload[8*32 +: 32] = pending_frame;
    bt656_diag_event_payload[9*32 +: 32] = pending_line;
    bt656_diag_event_payload[10*32 +: 32] = pending_capture;
    bt656_diag_event_payload[11*32 +: 32] = pending_attempt;
    bt656_diag_event_payload[12*32 +: 32] = source_lifetime_malformed;
    bt656_diag_event_payload[13*32 +: 32] = source_lifetime_dropped;
    bt656_diag_event_payload[14*32 +: 32] = pending_flags;
    bt656_diag_event_payload[15*32 + 0 +: 13] = payload_byte_count;
    bt656_diag_event_payload[15*32 + 13 +: 3] = post_payload_count;
    bt656_diag_event_payload[15*32 + 16 +: 3] = {1'b0, marker_fill};
    bt656_diag_event_payload[15*32 + 19 +: 2] =
        allocation_choice[2] ? allocation_choice[1:0] : 2'b0;
    bt656_diag_event_payload[15*32 + 21 +: 4] = malformed_reason;
    bt656_diag_event_payload[15*32 + 25 +: 4] = drop_reason;
  end
