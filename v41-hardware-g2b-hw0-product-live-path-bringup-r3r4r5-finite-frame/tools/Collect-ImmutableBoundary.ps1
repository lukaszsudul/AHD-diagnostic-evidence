...
$currentEvidenceRoot = Join-Path $evidenceRoot 'v41-hardware-g2b-hw0-product-live-path-bringup-r3r4r5-finite-frame'
$fixedRoots = @(
  ...
  'C:\FPGA\G2B_HW0_PRODUCT_R3R4R1_20260907T050126Z',
  'C:\FPGA\G2B_HW0_PRODUCT_R3R4R2_20260907T071912Z',
  'C:\FPGA\G2B_HW0_PRODUCT_R3R4R3_20260907T075856Z',
  'C:\FPGA\G2B_HW0_PRODUCT_R3R4R4_20260907T135724Z',
  ...
  'C:\FPGA\V41_G2B_DRV',
  (Join-Path $evidenceRoot '.diag0-work'),
  (Join-Path $evidenceRoot '.meta8a-work'),
  $sourceRoot,
  (Join-Path $evidenceRoot 'project-current-state')
)

$evidenceRoots = @(Get-ChildItem -LiteralPath $evidenceRoot -Directory -Force |
  Where-Object { $_.Name -match '^v41-hardware-g2b-hw0-product-live-path-bringup-r3(?:$|r.*|-.*)' } |
  Where-Object { $_.FullName -cne $currentEvidenceRoot } |
...
$snapshot = [ordered]@{
  schema = 'R3R4R5_IMMUTABLE_BOUNDARY_V1'
  phase = $Phase
