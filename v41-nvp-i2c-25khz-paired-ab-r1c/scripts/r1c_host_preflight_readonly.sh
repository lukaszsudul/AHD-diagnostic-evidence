#!/usr/bin/env bash
# R1c read-only kernel/boot/PCI/driver preflight. No files, modules, PCI state,
...
for evidence_dir in \
  /home/vcdeagent1/FPGA_AHD_HOST/v41_nvp_i2c_25khz_r1c/pre_arm_a_driver \
  /home/vcdeagent1/FPGA_AHD_HOST/v41_nvp_i2c_25khz_r1c/arm_a_driver \
  /home/vcdeagent1/FPGA_AHD_HOST/v41_nvp_i2c_25khz_r1c/arm_b_driver; do
  state=ABSENT_FRESH
