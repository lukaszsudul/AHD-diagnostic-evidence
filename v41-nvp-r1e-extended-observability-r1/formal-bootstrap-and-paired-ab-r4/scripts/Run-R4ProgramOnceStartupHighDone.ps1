[CmdletBinding()]
param(
    [Parameter(Mandatory)][ValidateSet('FORMAL_BOOTSTRAP','ARM_A_R1E','ARM_B_FORMAL')][string]$Role,
...
$diagnosticFilename = 'ahd_capture_v41_i2c_25khz_r1e_observability.bit'
$diagnosticSize = 2192144L
$diagnosticSha = '0BDE629B9AA1DD2846E4314E94D7C6734825037CBCC2D7271DF7ACBABE8A7DB9'
$diagnosticSourceCommit = 'f3d9e5cdcacfb6fdebed5e5fe8b9143ef226aebd'
...
if ($Role -in @('FORMAL_BOOTSTRAP','ARM_B_FORMAL') -and
...
$tclRole = if ($Role -eq 'ARM_A_R1E') {'ARM_A_25KHZ'} else {'ARM_B_FORMAL_50KHZ'}

$command = @(
    'call',(Assert-CmdToken $settings),'&&',(Assert-CmdToken $vivado),
    '-mode','batch','-notrace','-source',(Assert-CmdToken $tcl),'-tclargs',
    (Assert-CmdToken $tclRole),(Assert-CmdToken $bit),(Assert-CmdToken $ExpectedFilename),
