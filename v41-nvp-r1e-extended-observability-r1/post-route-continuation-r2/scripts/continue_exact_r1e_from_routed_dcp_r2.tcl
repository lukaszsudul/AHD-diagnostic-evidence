if {$argc != 4} {
  puts stderr "usage: continue_exact_r1e_from_routed_dcp_r2.tcl COMMON_TCL ROUTED_DCP OUTPUT_ROOT BIT_PATH"
  exit 2
}
...
set bit_path [file normalize [lindex $argv 3]]
source $common_tcl
set gate_info [r1e_r2::gate_open_design $routed_dcp $output_root WRITE_CAPABLE_CONTINUATION]
...
r1e_r2::write_lines [file join $output_root WRITE_CONTINUATION_RESULT.txt] [list \
