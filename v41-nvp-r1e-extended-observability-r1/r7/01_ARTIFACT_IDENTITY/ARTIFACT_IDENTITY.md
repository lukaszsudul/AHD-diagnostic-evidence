# R7 frozen artifact identity

The R1e implementation and exact formal control were verified locally without
opening a design checkpoint and without changing source or generated
artifacts.
...
The task-local bit copies are under `01_ARTIFACT_IDENTITY/artifacts`. Their
post-copy sizes and SHA-256 identities equal the frozen R6/evidence identities
exactly.
