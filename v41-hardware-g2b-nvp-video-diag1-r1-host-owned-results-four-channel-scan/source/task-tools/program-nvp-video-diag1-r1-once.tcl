# G2B-NVP-VIDEO-DIAG1-R1 fail-closed single volatile SRAM program procedure.
# The Windows supervisor supplies the exact full-build bitstream identity.
if {$argc != 3} {
  puts stderr {usage: program-nvp-video-diag1-r1-once.tcl BITFILE SIZE SHA256}
  exit 2
}
...
set expected_filename {G2B_NVP_VIDEO_DIAG1_R1_FOUR_CHANNEL_SCAN.bit}
...
set invoked 0
set rc 0
emit TASK_ID G2B-NVP-VIDEO-DIAG1-R1
emit CANDIDATE_CLASS G2B_NVP_VIDEO_DIAG1_R1_HOST_OWNED_RESULTS_CANDIDATE
